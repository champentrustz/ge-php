...
if($search === 'true'){
    ...
    $semester_sql = "SELECT DISTINCT semester,year FROM survey WHERE teacher_name like '%" . $teacher_name . "%' order by year desc ,  semester desc ";
...
<div class="container">
    ...
    <div class="col-md-12">
        ...
        <label>รายการแบบประเมินของ <?php print $teacher_name?></label>
            ...
            foreach ($details as $detail) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button onclick=" window.open('teacher-summary-view.php?teacher_name=<?php print $detail['teacher_name']?>&survey_name=<?php print $detail['topic']?>&semester=<?php print $detail['semester']?>&year=<?php print $detail['year']?>','summary-survey ','width=1200,height=1000');"
