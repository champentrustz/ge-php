    ...
    <div class="tab-content">
        ...
        <div id="menu1" class="tab-pane fade in active">
            ...
            <div class="col-md-12 text-right">
                ...
                <a class="btn btn-success" href="teacher-summary-excel.php?teacher_name=<?php print $teacher_name?>&survey_name=<?php print $survey_name?>&semester=<?php print $semester?>&year=<?php print $year?>"><span class="glyphicon glyphicon-download-alt"></span> ดาวน์โหลดไฟล์ excel</a>
            </div>
            <div class="col-md-12">
                <br>
                <br>
        ...
        <div id="menu3" class="tab-pane fade">
            ...
            <div class="col-md-12 text-right">
                <a class="btn btn-success" href="teacher-summary-score-excel.php?teacher_name=<?php print $teacher_name?>&survey_name=<?php print $survey_name?>&semester=<?php print $semester?>&year=<?php print $year?>"><span class="glyphicon glyphicon-download-alt"></span> ดาวน์โหลดไฟล์ excel</a>
            </div>
        ...
        <div id="menu4" class="tab-pane fade">
            ...
            <div class="col-md-12">
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-success" href="teacher-summary-remark-excel.php?teacher_name=<?php print $teacher_name?>&survey_name=<?php print $survey_name?>&semester=<?php print $semester?>&year=<?php print $year?>"><span class="glyphicon glyphicon-download-alt"></span> ดาวน์โหลดไฟล์ excel</a>
                </div>
                <br>
                <br>
