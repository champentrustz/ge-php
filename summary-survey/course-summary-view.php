    ...
    <div class="tab-content">
        ...
        <div id="menu1" class="tab-pane fade in active">
            ...
            <div class="col-md-12 text-right">
                ...
                <a class="btn btn-success" href="course-summary-excel.php?survey_name=<?php print $survey_name?>&course_id=<?php print $course_id?>&semester=<?php print $semester?>&year=<?php print $year?>"><span class="glyphicon glyphicon-download-alt"></span> ดาวน์โหลดไฟล์ excel</a>
